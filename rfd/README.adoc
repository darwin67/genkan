...
|link:0004/README.adoc[4: Dynamic HEIC desktop wallpaper]
|Time-of-day HEIC scheduling, optional GeoClue solar selection, and Wayland desktop rendering
|===
...
Implementation progress lives separately in `rfd/NNNN/IMPLEMENTATION.adoc` or
...
one implementation checklist (`IMPLEMENTATION.adoc` or `IMPLEMENTATION.md`) in a
