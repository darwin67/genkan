...
fn spawn(
    ...
    // SAFETY: all argv strings and the inherited environment remain alive for this call.
    let result = unsafe {
        libc::posix_spawn(
            &mut pid,
            executable.as_ptr(),
